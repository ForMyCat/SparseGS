...
import numpy as np
# import os, sys
# sys.path.append(os.path.join(os.path.dirname(__file__), "BoostingMonocularDepth"))
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./BoostingMonocularDepth/pix2pix/checkpoints', help='models are saved here')
        # model parameters
